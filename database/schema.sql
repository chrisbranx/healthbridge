...
CREATE INDEX idx_adherence_date ON medication_adherence(taken_at);
...
CREATE INDEX idx_chw_assignments_chw ON chw_patient_assignments(chw_id);
CREATE INDEX idx_chw_assignments_patient ON chw_patient_assignments(patient_id);
...
CREATE INDEX idx_chw_tasks_chw ON chw_tasks(chw_id);
CREATE INDEX idx_chw_tasks_status ON chw_tasks(status);
CREATE INDEX idx_chw_tasks_patient ON chw_tasks(patient_id);
...
CREATE INDEX idx_escalations_status ON escalation_alerts(status);
CREATE INDEX idx_escalations_severity ON escalation_alerts(severity);
CREATE INDEX idx_escalations_clinic ON escalation_alerts(clinic_id);
...
CREATE INDEX idx_ussd_sessions_session ON ussd_sessions(session_id);
...
CREATE INDEX idx_sms_log_type ON sms_log(message_type);
...
ALTER TABLE chw_tasks ENABLE ROW LEVEL SECURITY;
